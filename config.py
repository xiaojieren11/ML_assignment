...
def get_parser():
    ...
    parser.add_argument('--win_width', type=int, default=90, help='Number of time steps for the sliding window.')
    parser.add_argument('--hidden_size', type=int, default=128, help='Hidden size for the LSTM model.')
    parser.add_argument('--embed_dim', type=int, default=128, help='Embedding dimension for the Transformer model.')
    parser.add_argument('--dense_dim', type=int, default=256, help='Dense dimension for the Transformer model.')
